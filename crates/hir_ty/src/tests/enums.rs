    ...
    check(
        ...
        expect![[r#"
            ...
            main::lambda#main : main::main() -> void
              ...
              8 : type
              10 : main::Animal.Fish
              11 : main::go_do_animal_stuff_idk(main::Animal) -> void
              12 : main::Animal.Dog
              13 : void
              14 : main::go_do_animal_stuff_idk(main::Animal) -> void
              15 : main::Animal.Fish
              16 : void
              17 : void
              18 : main::main() -> void
              l0 : main::Animal.Dog
              l1 : main::Animal.Fish
            main::go_do_animal_stuff_idk : main::go_do_animal_stuff_idk(main::Animal) -> void
              21 : main::go_do_animal_stuff_idk(main::Animal) -> void
            main::lambda#go_do_animal_stuff_idk : main::go_do_animal_stuff_idk(main::Animal) -> void
              20 : void
              21 : main::go_do_animal_stuff_idk(main::Animal) -> void
        "#]],
        |_| [],
    ...
    check(
        ...
        expect![[r#"
            ...
            main::lambda#main : main::main() -> void
              ...
              14 : main::Animal
              15 : void
              16 : main::go_do_animal_stuff_idk(main::Animal) -> void
              17 : main::Animal.Fish
              19 : main::Animal
              20 : void
              21 : void
              ...
              l1 : main::Animal.Fish
            main::go_do_animal_stuff_idk : main::go_do_animal_stuff_idk(main::Animal) -> void
              25 : main::go_do_animal_stuff_idk(main::Animal) -> void
            main::lambda#go_do_animal_stuff_idk : main::go_do_animal_stuff_idk(main::Animal) -> void
              24 : void
              25 : main::go_do_animal_stuff_idk(main::Animal) -> void
        "#]],
            ...
            [
                (
                    TyDiagnosticKind::NotAVariantOfSumType {
                        ty: Ty::EnumVariant {
                            enum_uid: 9,
                            variant_name: Name(i.intern("Crazy_Kool_Variant")),
                            uid: 7,
                            sub_ty: Ty::Void.into(),
                            discriminant: 0,
                        }
                ...
                (
                    TyDiagnosticKind::NotAVariantOfSumType {
                        ty: Ty::EnumVariant {
                            enum_uid: 9,
                            variant_name: Name(i.intern("Other_Kool_Variant")),
                            uid: 8,
                            sub_ty: Ty::Void.into(),
                            discriminant: 1,
                        }
